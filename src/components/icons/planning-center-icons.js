...
export const PCLogoColorReversed = props => (
  <svg id="Layer_1" width="196" height="28" {...props}>
    <path
      d="M23.9 2.8C25.8 3.3 27 5.1 27 7v13.3c0 1.9-1.3 3.6-3.1 4.2L15.7 27c-1.4.4-3 .4-4.4 0l-8.2-2.4C1.3 24 0 22.2 0 20.3V7c0-1.9 1.3-3.6 3.1-4.2L11.3.4c1.4-.4 3-.4 4.4 0l8.2 2.4z"
      fill="#3b78ff"
    />
...
export const PCLogoMono = props => (
  <svg viewBox="0 0 196 28" width="196" height="28" {...props}>
    ...
    />
    <path
      d="M23.9 2.8C25.8 3.3 27 5.1 27 7v13.3c0 1.9-1.3 3.6-3.1 4.2L15.7 27c-1.4.4-3 .4-4.4 0l-8.2-2.4C1.3 24 0 22.2 0 20.3V7c0-1.9 1.3-3.6 3.1-4.2L11.3.4c1.4-.4 3-.4 4.4 0l8.2 2.4zm-3.4 13.5v-7c0-1-1-1.8-2-1.5l-4.8 1.4c-.2 0-.3.1-.5 0L8.4 7.8c-1-.3-1.9.4-1.9 1.4V20c0 .2.1.4.3.4l1.8.5c.3.1.5-.1.5-.4V18s0-.1.1-.1l3.6 1.1c.5.1 1 .1 1.4 0l5.4-1.7c.6-.1.9-.5.9-1zm-2.9-5.4c.1 0 .3.1.3.2V15c0 .1-.1.2-.2.2l-3.9 1.2c-.2.1-.4.1-.6 0l-3.8-1.1c-.1 0-.2-.1-.2-.2v-4c0-.1.1-.2.3-.2l3.1.9c.6.2 1.3.2 1.9 0l3.1-.9z"
    />
  </svg>
);
...
export const IconFacebook = props => (
  <svg viewBox="0 0 23.976 24" {...props}>
    <path
      d="M16.356 9.074L16.01 12h-2.566v8.777H9.667V12H7.62V9.074h2.047V7.122c0-2.463 1.029-3.9 4.146-3.9h2.543v2.927h-1.524c-1.215 0-1.388.4-1.388 1.184v1.741z"
    />
  </svg>
);
...
export const IconInstagram = props => (
  <svg viewBox="0 0 23.976 24" {...props}>
    <path
      d="M15.724 15.693A5.258 5.258 0 0 0 17.261 12h3.727v6.7a2.251 2.251 0 0 1-2.2 2.3H5.285a2.331 2.331 0 0 1-2.3-2.3V12h3.777A5.265 5.265 0 0 0 8.3 15.7a5.268 5.268 0 0 0 7.425 0zm-3.759.026a3.75 3.75 0 1 1 3.75-3.75 3.749 3.749 0 0 1-3.75 3.75zM19.488 6.9a.6.6 0 0 1-.6.6h-1.8a.6.6 0 0 1-.6-.6V5.1a.6.6 0 0 1 .6-.6h1.8a.6.6 0 0 1 .6.6zM8.3 8.268a5.251 5.251 0 0 1 8.747 2.232h3.941V5.2a2.17 2.17 0 0 0-2.2-2.2H5.285a2.251 2.251 0 0 0-2.3 2.2v5.3h3.991A5.183 5.183 0 0 1 8.3 8.268z"
    />
  </svg>
);
...
export const IconTwitter = props => (
  <svg viewBox="0 0 23.976 24" {...props}>
    <path
      d="M21.7 5.945a8.018 8.018 0 0 1-2.287.632 4.015 4.015 0 0 0 1.753-2.215 7.9 7.9 0 0 1-2.531.971 3.994 3.994 0 0 0-6.788 3.65A11.273 11.273 0 0 1 3.63 4.8a4.021 4.021 0 0 0 1.238 5.348 3.868 3.868 0 0 1-1.81-.5v.05a4 4 0 0 0 3.2 3.926 3.988 3.988 0 0 1-1.049.141 3.717 3.717 0 0 1-.749-.075 3.991 3.991 0 0 0 3.72 2.778 7.959 7.959 0 0 1-4.949 1.715 7.854 7.854 0 0 1-.95-.058 11.093 11.093 0 0 0 6.1 1.811 11.294 11.294 0 0 0 11.343-11.4c0-.173 0-.347-.013-.516A8.12 8.12 0 0 0 21.7 5.945z"
    />
  </svg>
);
